...
#ifndef __H_KCL_MANIPULATOR_FAR_MARKER__
#define __H_KCL_MANIPULATOR_FAR_MARKER__ "__H_MANIPULATOR_FAR_MARKER__"

#include "ros/ros.h"
#include "knowledge_base_tools/robocluedo_kb_tools.h"
#include "robocluedo_rosplan_action_interface/RPActionInterface.h"

#define NODE_NAME "manipulator_far_marker"
...
/********************************************//**
 * 
 * \class RP_manipulator_far_marker
 * 
 * \brief implementation of the action manipulator_far_marker
 * 
 * ... more details
 * 
 ***********************************************/
class RP_manipulator_far_marker : public RPActionInterface, public robocluedo_kb_tools
{
public:
	
	/// empty constructor (don't use it!)
	RP_manipulator_far_marker( );
	 ...
	 * 
	 ***********************************************/
	RP_manipulator_far_marker( ros::NodeHandle &nh, bool debug_mode = KB_TOOLS_DEFAULT_DEBUG_MODE );
